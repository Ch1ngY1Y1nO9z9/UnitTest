                ...
                <div class="flex flex-wrap -m-2">
                    @foreach ($productTypes as $type)
                        <div class="p-2 lg:w-1/3 md:w-1/2 w-full ">
                            <a href="/Types/{{$type->id}}" target="_blank">
                                <div
                        ...
                        <div class="py-8 px-4 lg:w-1/3">
                            <div class="h-full flex items-start">
                                {{-- <div class="w-12 flex-shrink-0 flex flex-col text-center leading-none">
                                    <span class="text-white pb-2 mb-2 border-b-2 border-gray-100">{{date('M', strtotime($news->date))}}</span>
                                    <span class="font-medium text-lg text-white title-font leading-none">{{date('d', strtotime($news->date))}}</span>
                                </div> --}}
                ...
                <div class="flex flex-wrap -m-4 w-full">
                    @foreach ($partners as $partner)
                        <div class="p-4 lg:w-1/2 md:w-full">
                            <div
                                class="flex bg-white border-2 rounded-lg border-gray-200 border-opacity-50 p-4 sm:flex-row flex-col">
                                <img class="h-40 rounded object-cover object-center mr-4"
        ...
        <section class="text-gray-600 body-font relative">
            <div class="absolute inset-0 bg-gray-300">
                <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map"
                    scrolling="no"
                    src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=形象廣告媒體公司&ie=UTF8&t=&z=14&iwloc=B&output=embed"
                    style="filter: grayscale(1) contrast(1.2) opacity(0.5);"></iframe>
            </div>
            <div class="container px-5 py-24 mx-auto flex" id="ContactUs">
                <div
                    ...
                    <form action="/contact_us" method="post">
                        ...
                        <div class="relative mb-4">
                            <label for="companyWebsite" class="leading-7 text-sm text-gray-600">Company Website</label>
                        ...
                        <div class="flex space-x-4">
                            ...
                            <div class="relative mb-4">
                                <label for="business" class="leading-7 text-sm text-gray-600">Business Type</label>
                        ...
                        <div class="flex space-x-4">
                            <div class="relative mb-4">
                                <label for="tel" class="leading-7 text-sm text-gray-600">Phone</label>
                                <input type="tel" id="tel" name="phone" required
                                    class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            <div class="relative mb-4">
                                <label for="fax" class="leading-7 text-sm text-gray-600">Fax</label>
                                <input type="tel" id="fax" name="fax" required
                                    class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                        </div>
                        <div class="relative mb-4">
                    ...
                    <p class="text-xs text-gray-500 mt-3">Thank you for your message! We will get back to you as soon as
                        possible.</p>
                </div>
            </div>
        </section>
